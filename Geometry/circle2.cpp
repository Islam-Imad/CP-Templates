...
pt points_to_center(pt a, pt b, pt c)
{
...
circle points_to_circle(pt a, pt b, pt c)
{
    pt center = points_to_center(a, b, c);
...
void solve()
{
    circle a, b;
    cin >> a >> b;
    cout << fixed << setprecision(20) << common_circle_area(a, b) << "\n";
}
